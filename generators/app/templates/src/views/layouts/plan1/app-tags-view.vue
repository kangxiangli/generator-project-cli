...
.tags-view-container {
  --app-tag-bg: var(--light-gray-2);
  --app-tag-color: var(--guan-gray-7);
  ...
  --app-tag-bg-actived: linear-gradient(
    0deg,
    var(--guan-highlight-7),
    var(--guan-highlight-6)
  );
  --app-tag-text-actived-shadow: 0px 1px 2px var(--guan-highlight-8);
  ...
  & .tags-view-wrapper {
    ...
    .tags-view-item {
      ...
      &.active {
        ...
        font-weight: 500;
        border-radius: var(--app-tag-corner);
        text-shadow: var(--app-tag-text-actived-shadow);
        .el-icon-close:hover {
